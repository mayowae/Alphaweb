...
# 1. Upload fixes
upload('src/app/layout.tsx', f'{FRONTEND_PATH}/src/app/layout.tsx')
upload('src/app/admin/layout.tsx', f'{FRONTEND_PATH}/src/app/admin/layout.tsx')
upload('src/app/dashboard/(pages)/loan/(pages)/applications/page.tsx', f'{FRONTEND_PATH}/src/app/dashboard/(pages)/loan/(pages)/applications/page.tsx')

# 2. Run build
print("\n=== STARTING BUILD WITH FONT FIXES ===")
