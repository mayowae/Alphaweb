...
FILES_TO_UPLOAD = [
    (
        os.path.join(LOCAL_BASE, 'src', 'app', 'dashboard', '(pages)', 'loan', '(pages)', 'applications', 'page.tsx'),
        f'{REMOTE_BASE}/src/app/dashboard/(pages)/loan/(pages)/applications/page.tsx'
    ),
]
