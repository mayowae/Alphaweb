...
err_log = "/home/mayowae/public_html/alphaweb/logs/backend-error-0.log"
print(f"--- Last 10 lines of {err_log} with timestamps (if any) ---")
print(run(ssh, f"tail -n 10 {err_log}"))
