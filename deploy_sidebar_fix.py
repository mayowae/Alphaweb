...
upload('components/dashboard/Sidebar.tsx', f'{FRONTEND_PATH}/components/dashboard/Sidebar.tsx')
upload('components/admin/Sidebar.tsx', f'{FRONTEND_PATH}/components/admin/Sidebar.tsx')
upload('src/app/globals.css', f'{FRONTEND_PATH}/src/app/globals.css')
