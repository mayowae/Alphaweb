...
const getMerchantSubscriptions = async (req, res) => {
  try {
    ...
    const subscriptionData = {
      currentPlan: merchant.plan_id || 'Starter Pack', // needs to be enriched with Plan name later
      status: merchant.subscription_status || 'Active',
      billingCycle: 'Monthly',
      nextBillingDate: merchant.next_billing_date,
      totalDebt: merchant.total_debt,
      trialEndDate: merchant.trial_end_date,
      isCustomFee: merchant.is_custom_fee,
      customFee: merchant.custom_fee,
    };
