...
print("=== Listing /home/mayowae/suppakash.com ===")
...
print("=== Checking mail size for suppakash.com ===")
out, err = run("du -sh /home/mayowae/mail/suppakash.com 2>/dev/null || echo 'No mail dir'")
print(out)
