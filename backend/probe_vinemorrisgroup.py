...
print("=== Listing /home/mayowae/vinemorrisgroup.com ===")
...
print("=== Checking mail size for vinemorrisgroup.com ===")
out, err = run("du -sh /home/mayowae/mail/vinemorrisgroup.com 2>/dev/null || echo 'No mail dir'")
print(out)
