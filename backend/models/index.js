...
db.JournalEntry = require('./journalEntry')(sequelize, Sequelize.DataTypes);
db.JournalLine = require('./journalLine')(sequelize, Sequelize.DataTypes);
db.FiscalPeriod = require('./fiscalPeriod')(sequelize, Sequelize.DataTypes);
