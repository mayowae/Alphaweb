...
// Customer Wallet associations
db.Merchant.hasMany(db.CustomerWallet, { foreignKey: 'merchantId' });
db.CustomerWallet.belongsTo(db.Merchant, { foreignKey: 'merchantId' });

db.Customer.hasMany(db.CustomerWallet, { foreignKey: 'customerId', as: 'customer' });
db.CustomerWallet.belongsTo(db.Customer, { foreignKey: 'customerId', as: 'customer' });

// Investment Application associations
db.Merchant.hasMany(db.InvestmentApplication, { foreignKey: 'merchantId' });
db.InvestmentApplication.belongsTo(db.Merchant, { foreignKey: 'merchantId' });

db.Customer.hasMany(db.InvestmentApplication, { foreignKey: 'customerId' });
db.InvestmentApplication.belongsTo(db.Customer, { foreignKey: 'customerId' });

db.Agent.hasMany(db.InvestmentApplication, { foreignKey: 'agentId' });
db.InvestmentApplication.belongsTo(db.Agent, { foreignKey: 'agentId' });

db.Staff.hasMany(db.InvestmentApplication, { foreignKey: 'approvedBy' });
db.InvestmentApplication.belongsTo(db.Staff, { foreignKey: 'approvedBy' });
