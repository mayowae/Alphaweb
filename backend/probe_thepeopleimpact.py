...
print("=== Listing /home/mayowae/thepeopleimpact.com ===")
...
print("=== Checking mail size for thepeopleimpact.com ===")
out, err = run("du -sh /home/mayowae/mail/thepeopleimpact.com 2>/dev/null || echo 'No mail dir'")
print(out)
