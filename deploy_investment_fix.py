...
# 1. Upload updated investment applications page
upload('src/app/dashboard/(pages)/investment/(pages)/applications/page.tsx', f'{FRONTEND_PATH}/src/app/dashboard/(pages)/investment/(pages)/applications/page.tsx')
