...
const Page = () => {
  ...
  const data = [
    { id: 'INVN-10A-G12', customer: 'James Gibbins', Account_number: '9345456565', Package: 'Alpha4000', Amount: 'N1,000', Branch: "Yaro Area branch", Agent: 'Kola Adefarattti', Date: "23, July 2024" },
  ];
          ...
          <div className='flex flex-wrap flex-col md:flex-row items-center gap-2 md:gap-5 w-full md:w-auto'>
            ...
            <Select >
              ...
              <SelectContent className="w-full md:w-[185px] bg-white mt-1 rounded-[4px] shadow-lg p-0 border-none">
                <SelectGroup>
                  <SelectItem value="10" className="px-4 py-2 font-inter text-[13px] text-[#101828] hover:bg-gray-50 cursor-pointer transition-colors rounded-[4px]  ">Yaro Area branch</SelectItem>
                  <SelectItem value="15" className="px-4 py-2 font-inter text-[13px] text-[#101828] hover:bg-gray-50 cursor-pointer transition-colors rounded-[4px] ">Yaro Area branch</SelectItem>
                </SelectGroup>
              </SelectContent>
            </Select>
