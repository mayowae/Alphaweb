            ...
            <tbody className="border-b border-[#D9D4D4] w-full">
              {applications.map((application) => (
                <tr key={application.id} className="bg-white transition-all duration-500 hover:bg-gray-50">
                  <td className="px-5 py-4 text-gray-600 text-[14px] leading-[20px] font-lato font-normal ">{application.customerName}</td>
                  ...
                  <td className="px-5 py-4 text-gray-600 text-[14px] leading-[20px] font-lato font-normal ">{application.agentName || 'N/A'}</td>
