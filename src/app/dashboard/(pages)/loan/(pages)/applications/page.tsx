         ...
         <div className='overflow-auto w-full'>
          <table className="table-auto w-full whitespace-nowrap hidden md:table">
            ...
            <tbody className="border-b border-[#D9D4D4] w-full">
              <tr className="bg-white transition-all duration-500 hover:bg-gray-50">
                ...
                <td className="px-5 py-4 text-gray-600 text-[14px] leading-[20px] font-lato font-normal ">Kola branch</td>
          ...
          <div className="md:hidden block border-b p-2">
            <div className="flex flex-col gap-1">
              ...
              <div className="flex justify-between text-sm text-gray-600"><span>Branch:</span><span className="font-semibold">360</span></div>
              <div className="flex justify-between text-sm text-gray-600"><span>Date Applied:</span><span className="font-semibold">Daily</span></div>
