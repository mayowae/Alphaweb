...
def safe_deploy():
    ...
    files_to_upload = [
        r'backend\controllers\repaymentController.js',
        r'src\app\dashboard\(pages)\loan\(pages)\repayments\page.tsx',
        r'components\dashboard\Footer.tsx',
        r'components\admin\Footer.tsx',
        r'src\app\(auth)\signup\page.tsx'
    ]
    ...
    ssh.exec_command("pm2 restart all || (cd /home/mayowae/public_html/alphaweb/backend && pm2 start server.js)")
    
    # Also restart Next.js gracefully
